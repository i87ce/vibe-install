    ...
    $templateJson = @"
{
  ...
  "enabledPlugins": {
    ...
    "media-pipeline@media-pipeline-marketplace": true
  },
  "extraKnownMarketplaces": {
    ...
    "kicad-happy":                { "source": { "source": "github", "repo": "aklofas/kicad-happy" } },
    "media-pipeline-marketplace": { "source": { "source": "github", "repo": "guinacio/claude-image-gen" } },
